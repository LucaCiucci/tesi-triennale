...
La ricerca di evidenze è stata oggetto di numerosi esperimenti in quanto tali particelle risultano inquadrate nelle GUTs. Sono state concepite diverse metodologie, come ad esepio la ricerca di tracce elettriche su di anelli superconduttori, la radiazione di Cherenkov (AMANDA), l'analisi di segnali radio (ANITA) o l'analisi delle traiettorie sotto l'effetto di un campo magnetico (esperimento MoEDAL).\
